...
data_results_table_cont <- data.frame(
  ...
  eff_p05 = c('7.7 [-2.4, 17.9]',
                    '7.7 [-3.1, 18.7]'),
  
  eff_p25 = c('2.0 [-4.8, 8.8]',
                    '1.1 [-5.8, 8.2]'),
  
  eff_p50 = c('-1.7 [-7.7, 4.5]',
                    '-3.3 [-9.5, 2.8]'),
  
  eff_p75 = c('-7.2 [-14.1, -0.3]',
                    '-7.7 [-14.8, -0.5]'),
  
  eff_p95 = c('-17.4 [-30.0, -5.1]',
                    '-16.0 [-28.6, -3.8]'),
...
[Supplementary Figure 7](#fig-sup_figure_7): infection risk according to infliximab:aPE-ind IgG non-linear interaction.     

[Supplementary Figure 8](#fig-sup_figure_8): infection risk according to infliximab:aPE-dep IgG non-linear interaction.
...
[Table 1 and 2](#tbl-table_1_2): IFX x nAb non-linear interaction effects based on Bayesian multivariable models (include both Tables 1 and 2)
